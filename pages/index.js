...
export default function Home() {
  ...
  <div class="mt-8 text-center">
    <h1 class="text-4xl">Welcome to Hackathon Carbon Foodprint Project</h1>
  </div>

  <button class="mt-8 block rounded-lg border border-green-700 bg-green-600 py-1.5 px-4 font-medium text-white transition-colors hover:bg-green-700 active:bg-green-800 disabled:opacity-50" onClick={()=>router.push("./recipes")}>Get started</button>
